...
public class FileConnection {
	 ...
	 * @throws IOException 
	 */
	public ArrayList<Client> readingAllProduct() throws IOException{
	 ...
	 * @return
	 */
	public static ArrayList<Client> splitProductInfomation(ArrayList<String> arrLstProduct){
		ArrayList<Client> productLst = new ArrayList<Client>();
		Client productObj;
		String[] productTmp;
		for(int i = 0; i < arrLstProduct.size(); i++){
			productTmp = arrLstProduct.get(i).trim().split("-");

			productObj = new Client();
