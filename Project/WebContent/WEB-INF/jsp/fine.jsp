					...
					<div id="main">
						...
						<!-- Featured Post -->
							<article class="post featured">
								<header class="major">
									<h3> This Page Will Link You to Schedule Your appointment with Ms. B!!!! </h3>

	<h2> ${greetingsFine} </h2>
	
<form action="newspringclient.jsp" method="get">
	<input type="submit" value="Add a new Spring Client">
</form>
</br>
<form action="clientslist.jsp" method="GET">
	<input type="submit" value="Get Clients List "/>
</form><br/>
<br>
<a href="index.jsp"> Thanks For Visiting Our Web Page </a>
								</header>
